...
[[https://developer.mozilla.org/en-US/docs/JavaScript][JavaScript]] comes from [[http://www.ecmascript.org/][ECMAScript]] and has [[http://stackoverflow.com/a/2018747][nothing]] to do with [[http://www.oracle.com/technetwork/java/][Java]].
